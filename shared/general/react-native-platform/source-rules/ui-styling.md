...
// Correct – semantic type scale plus weight and color
<Text style={styles.title}>Title</Text>
<Text style={styles.subtitle}>Subtitle</Text>
<Text style={styles.caption}>Caption</Text>
```

Use a small semantic type scale and vary weight, color, spacing, and grouping
before inventing one-off sizes.
