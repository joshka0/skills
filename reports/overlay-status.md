...
- `thermo-nuclear-code-quality-review`: active local workflow for unusually strict maintainability review around structural simplification, file-size pressure, spaghetti branching, abstraction quality, and type/boundary cleanliness.
