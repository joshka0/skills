...
**Prefer OKLCH over HSL** when your target browsers support it. It's perceptually uniform, meaning equal steps in lightness *look* equal. If you support older engines, provide an sRGB or hex fallback before OKLCH, `color-mix()`, or `light-dark()` declarations.
