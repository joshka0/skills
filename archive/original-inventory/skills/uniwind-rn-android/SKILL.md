---
name: uniwind-rn-android
description: >
  Android-specific interface polish for Expo + React Native apps using Uniwind Pro.
  Use when designing or reviewing Android screens, Material-inspired UI,
  Android safe areas, edge-to-edge, navigation bars, top app bars, FABs,
  Android forms, touch targets, ripples, tonal surfaces, dynamic color,
  Android typography, Android motion, or platform-specific android: className variants.
  Triggers on: Android polish, native Android feel, Material 3, Material You,
  Android edge-to-edge, Android navigation bar, Android form, FAB, top app bar,
  Android touch target, Android theme, Android motion, Android UI review.
---
