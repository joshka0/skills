...
description: >
  Google Play store listing and metadata readiness for Android apps. Use when writing
  or reviewing app title, short description, full description, screenshots, feature
  graphic, icon, preview video, promotional claims, localization, ASO, tags, category,
  contact details, privacy links, and listing consistency.
  Triggers on: Play Store listing, Google Play metadata, screenshots, feature graphic,
  Android app icon, short description, full description, app title, ASO, localization,
  store assets, promotional claims, metadata policy, app category, contact details.
---
