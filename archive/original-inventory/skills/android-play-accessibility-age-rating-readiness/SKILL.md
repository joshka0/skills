...
description: >
  Android accessibility, Google Play content rating, target audience, Families,
  age gating, minors, ads for children, and age-restricted functionality readiness.
  Use when preparing Play app content questionnaires, target audience settings,
  content rating, accessibility QA, child/teen access, dating/matchmaking, gambling,
  UGC, AI content, and Android accessibility behavior.
  Triggers on: content rating, target audience, Families policy, children, minors,
  age gate, age-restricted content, accessibility, TalkBack, screen reader, font scale,
  touch target, contrast, dating, matchmaking, gambling, ads SDK, IARC.
---
