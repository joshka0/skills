...
description: >
  Google Play Data safety, privacy policy, account deletion, SDK data collection,
  personal/sensitive data, and Android permissions readiness. Use before Play review
  when the app collects data, uses third-party SDKs, requests runtime permissions,
  contacts, location, camera, microphone, photos/videos, files, health data, device IDs,
  advertising ID, notifications, or account deletion.
  Triggers on: Data safety, privacy policy, user data, permissions, contacts permission,
  location permission, photo picker, READ_CONTACTS, ACCESS_FINE_LOCATION, SDK data,
  data deletion, account deletion, prominent disclosure, Play privacy, Expo permissions.
---
