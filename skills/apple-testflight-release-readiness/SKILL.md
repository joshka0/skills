...
description: >
  TestFlight beta, crash, feedback, performance, tester group, and release health
  readiness before App Store submission. Use when evaluating whether enough beta
  evidence exists, triaging TestFlight crashes, preparing What to Test notes, or
  deciding if a build is safe to submit.
  Triggers on: TestFlight, beta testers, external testing, crash triage, beta
  feedback, performance diagnostics, hangs, disk writes, launch diagnostics,
  What to Test, build health, release candidate.
---
