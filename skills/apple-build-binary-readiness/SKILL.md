...
description: >
  Technical build, binary, signing, entitlement, SDK, permission, and upload
  readiness for Apple App Store submissions. Use before TestFlight, App Store
  upload, or submission. Coordinates with asc-xcode-build, asc-signing-setup,
  asc-build-lifecycle, and asc-submission-health.
  Triggers on: Xcode build, iOS build, App Store binary, IPA, PKG, signing,
  provisioning, entitlements, Info.plist, purpose strings, SDK requirement,
  encryption compliance, build number, upload failure, ITMS error, Expo EAS iOS.
---
