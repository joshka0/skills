...
description: >
  Accessibility, age rating, creator-content age gating, and Apple accessibility
  metadata readiness. Use when preparing Accessibility Nutrition Labels, testing
  VoiceOver, Dynamic Type, contrast, reduced motion, captions, dark mode, or
  updated App Store age-rating questions.
  Triggers on: accessibility, VoiceOver, Dynamic Type, Larger Text, contrast,
  reduced motion, dark mode, Accessibility Nutrition Labels, age rating, age gate,
  creator content, minors, parental controls, kids category, content rating.
---
