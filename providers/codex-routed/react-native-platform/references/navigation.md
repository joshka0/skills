...
Rules for native navigation in React Native and Expo Router apps.

---

## Use Native Navigators for Navigation

Prefer native navigators for app-level stacks, tabs, headers, gestures, and
platform feel. Native navigators use platform APIs (UINavigationController on
iOS, Fragment on Android) for better performance and native behavior. Use JS
navigators only when the app explicitly needs custom transitions or navigation
surfaces that native navigators cannot provide.
